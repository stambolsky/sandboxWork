...
public class ProfileScheduleWorkTests extends TestBase {
    ...
    public void testOpeningWindowScheduleWork() throws InterruptedException {
        ...
        assertEquals(app.findGetText("//h5[contains(text(),'Изменение графика работы')]"),"Изменение графика работы");
        ...
        String after = app.findGetText("//div[@class='m-stack__item m-stack__item--center m-stack__item--fluid schedule-monday']");
